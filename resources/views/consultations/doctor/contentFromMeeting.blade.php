            ...
            <form class="mdl-grid form">
                ...
                <div class="mdl-cell mdl-cell--6-col">
                    <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input class="mdl-textfield__input" id="doctor_id" type="text" value="{{ $doctor }}" name="doctor_id" readonly autofocus>
                    ...
                    <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input class="mdl-textfield__input" id="patient_id" type="text" name="patient_id" readonly required>
                ...
                <div class="mdl-cell mdl-cell--6-col">
                    ...
                    <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input class="mdl-textfield__input" id="reference" type="text" name="reference">
