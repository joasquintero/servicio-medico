<div class="mdl-grid demo-content">
          ...
          <h4>Citas pendientes</h4>
            <hr>
                <table class="table mdl-data-table mdl-js-data-table mdl-shadow--4dp">
                    ...
                    @foreach ($doc_meetings as $meeting)
                        <tr>
                            <td name="id">{{ $meeting->id }}</td>
                            <td name="patient_id">{{ getUserName($meeting->doctor_id) }}</td>
          ...
          <div class="demo-cards mdl-cell mdl-cell--5-col mdl-cell--8-col-tablet mdl-grid mdl-grid--no-spacing">
            ...
            <h2 class="mdl-card__title-text">Días Laborales</h2>
            <hr>
              <table class = "mdl-cell mdl-cell--12-col mdl-data-table mdl-js-data-table">
                  ...
                  <tbody>
                      <tr>
                          <td>
                              <label for="lunes" class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect is-checked">
